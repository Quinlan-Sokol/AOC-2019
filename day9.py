...
s = list(map(int, s.split(","))) + [0]*50000000
...
while i < len(s) and s[i] != 99:
    ...
    if op == 1:
        if p3 == 2:
            s[base + s[i + 3]] = (s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) + (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2])
        else:
            s[s[i + 3]] = (s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) + (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2])
        i += 4
    elif op == 2:
        if p3 == 2:
            s[base + s[i + 3]] = (s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) * (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2])
        ...
        print(s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1])
        i += 2
    elif op == 5:
        i = (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2]) if ((s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) != 0) else i + 3
    elif op == 6:
        i = (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2]) if ((s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) == 0) else i + 3
    elif op == 7:
        if p3 == 2:
            s[base + s[i + 3]] = 1 if ((s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) < (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2])) else 0
        else:
            s[s[i + 3]] = 1 if ((s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) < (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2])) else 0
        i += 4
    elif op == 8:
        if p3 == 2:
            s[base + s[i + 3]] = 1 if ((s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]) == (s[s[i + 2]] if p2 == 0 else s[base + s[i + 2]] if p2 == 2 else s[i + 2])) else 0
        ...
        base += s[s[i + 1]] if p1 == 0 else s[base + s[i + 1]] if p1 == 2 else s[i + 1]
        i += 2
